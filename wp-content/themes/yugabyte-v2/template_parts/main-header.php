	...
	<div class="container">
		...
		<div class="menu-container collapse navbar-collapse" id="main-navbar">
			...
			<ul id="menu-main-menu" class="nav">
				...
				<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-601" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-601 nav-item"><a title="Open Source" href="#" class="nav-link">Open Source</a>
					<ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-13" role="menu">
						...
						<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1537" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1537 nav-item"><a title="Community" href="/community" class="dropdown-item">Community</a></li>
					</ul>
				</li>				
		...
		<div class="menu-container" id="mobile-navbar">
			<ul class="nav">
				...
				<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-601" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-601 nav-item">
					<div class="expandable-header">
						<a title="Open Source" href="#" class="nav-link">Open Source</a>
						<div class="action-dropdown open">
							<i class="fa fa-angle-down"></i>
							<i class="fa fa-angle-up"></i>
						</div>
					</div>
					<ul class="sub-nav-menu" aria-labelledby="menu-item-dropdown-13" role="menu">
						<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1536" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1536 nav-item"><a title="YugabyteDB" href="/yugabytedb" class="dropdown-item">YugabyteDB</a></li>
						<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-1537" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1537 nav-item"><a title="Community" href="/community" class="dropdown-item">Community</a></li>
					</ul>
				</li>				
