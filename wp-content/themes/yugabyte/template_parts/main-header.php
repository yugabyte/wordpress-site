	...
	<div class="container">
		...
		<div class="menu-container collapse navbar-collapse" id="main-navbar">
			...
			<ul id="menu-main-menu" class="nav">
				...
				<li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-601" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown menu-item-601 nav-item"><a title="Community" href="/community" class="nav-link">Community</a>
					<ul class="dropdown-menu" aria-labelledby="menu-item-dropdown-12" role="menu">
