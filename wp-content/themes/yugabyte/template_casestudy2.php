...
<html>
  ...
  <body class="cs2">
    ...
    <?php if(have_rows('testimonials')) { ?>
      <section class="cs2__testimonials-wrapper <?php the_field('testimonials_css_class'); ?>">
        <div class="container">
          <div class="cs2__testimonials">
            <div class="row">
    ...
    <?php if(get_field('technical_header')) { ?>
    ...
    <?php if(get_field('business_header')) { ?>
      <section class="cs2__business-results">
        <div class="container">
          <div class="row">
            <div class="col">
              <h1 class="cs2__business-results__title">
                <?php the_field('business_header'); ?>
              </h1>
              <div class="cs2__business-results__content">
            ...
            <?php if(get_field('show_extra_testimonial')) { ?>
              <div class="col">
                <div class="cs2__business-results__testimonial">
                  <div class="cs2__business-results__testimonial-image-col">
                    <img src="<?php the_field('extra_testimonial_picture'); ?>" />
                    <div class="cs2__business-results__testimonial-title">
                      <?php the_field('extra_testimonial_title'); ?>
                    </div>
                  </div>
                  <div class="cs2__business-results__testimonial-text">
                    <?php the_field('extra_testimonial_text'); ?>
                  </div>
                </div>
              </div>
            <?php } ?>
