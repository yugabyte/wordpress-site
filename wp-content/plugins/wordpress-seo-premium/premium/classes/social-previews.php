...
class WPSEO_Social_Previews {
	...
	private function register_assets() {
		...
		wp_register_script(
			...
			plugin_dir_url( WPSEO_PREMIUM_FILE ) . 'assets/js/dist/yoast-premium-social-preview-' . $version . WPSEO_CSSJS_SUFFIX . '.js',
			array( 'jquery', 'jquery-ui-core', 'yoast-seo-premium-commons', WPSEO_Admin_Asset_Manager::PREFIX . 'analysis' ),
			WPSEO_VERSION
		);
